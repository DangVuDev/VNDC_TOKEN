...
cd "frontend\web\vndc-ui" ; npm install
cd "offchain\backend-go" ; go mod download
```
...
- Frontend env: [frontend/web/vndc-ui/.env](frontend/web/vndc-ui/.env)
...
- [frontend/web/vndc-ui/.env](frontend/web/vndc-ui/.env)
- [Frontend/Web/react-vite-ts/src/lib/contracts.ts](frontend/web/vndc-ui/src/lib/contracts.ts)
...
```powershell
cd "offchain\backend-go" ; go run ./cmd/server
```
...
```powershell
cd "frontend\web\vndc-ui" ; npm run dev
```
...
Kiểm tra [frontend/web/vndc-ui/.env](frontend/web/vndc-ui/.env) có cấu hình đúng:
...
2. Sync lại [frontend/web/vndc-ui/src/lib/contracts.ts](frontend/web/vndc-ui/src/lib/contracts.ts).
...
- [frontend/web/vndc-ui/.env](frontend/web/vndc-ui/.env): cấu hình frontend local
